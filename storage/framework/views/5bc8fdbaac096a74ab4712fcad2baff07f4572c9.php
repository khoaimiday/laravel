    ...
    <div class="footer-first">
        <div class="footer-inner">
            ...
            <div class="footer-width-50">
                <div class="slogan">
                    <img src="<?php echo e(url('img/footer/logo-company.png')); ?>" alt="">
                ...
                <div class="download-app">
                    <a href="https://appstore.com" class="icon-appstore-footer"><img
                            src="<?php echo e(url('img/footer/download-appstore.png')); ?>"></a>
                    <a href="https://play.google.com" class="icon-android-footer"><img
                            src="<?php echo e(url('img/footer/download-googleplay.png')); ?>"></a>
                </div>
            </div>
        </div>
    </div>
    <div class="footer-second">
        <div class="footer-inner">
            <div class="footer-width-50">
                ...
                <div class="pull-left"><img src="<?php echo e(url('img/footer/payment.png')); ?>" alt="" width="40%"></div>
                <div class="pull-left"><img src="<?php echo e(url('img/footer/payment_cashdelivery.png')); ?>" alt="" width="30%"></div>
            </div>
            <div class="footer-width-25">
                <div class="footer-title">Dịch vụ giao nhận</div>
                <div class="pull-left"><img src="<?php echo e(url('img/footer/delivery_ahamove.png')); ?>" alt="" width="35%">
                    <img src="<?php echo e(url('img/footer/delivery_GHN.png')); ?>" alt="" width="30%"></div>
                <div class="pull-left"><img src="<?php echo e(url('img/footer/delivery_ninjavan.png')); ?>" alt="" width="35%"></div>
            </div>
            <div class="footer-width-25">
                <div class="footer-title">Chứng nhận bởi</div>
                <div class="pull-left"><img src="<?php echo e(url('img/footer/verify_boCT.png')); ?>" alt="" width="70%"></div>
            </div>
        </div>
    </div>
        ...
        <div class="footer-inner">
            ...
            <div class="footer-width-25">
                <div class="pull-left follow-icon">
                    <a href="https://www.facebook.com" class=""><img src="<?php echo e(url('img/footer/follow_fb.png')); ?>" alt=""></a>
                    <a href="https://www.instagram.com" class=""><img src="<?php echo e(url('img/footer/follow_in.png')); ?>" alt=""></a>
                    <a href="https://twitter.com" class=""><img src="<?php echo e(url('img/footer/follow_tt.png')); ?>" alt=""></a>
                    <a href="https://www.youtube.com" class=""><img src="<?php echo e(url('img/footer/follow_yt.png')); ?>" alt=""></a>
                    <a href="https://www.linkedin.com" class=""><img src="<?php echo e(url('img/footer/follow_ln.png')); ?>" alt=""></a>
                </div>
            </div>
            <div class="footer-width-25">
                <div class="copyright">
                    <strong>Copyright &copy; 2020 <a href="<?php echo e(url('/index')); ?>"> Cucumber</a>.</strong>
                </div>
            </div>
        </div>
    </div>
...
<?php /**PATH E:\xampp\htdocs\laravel\laravel\resources\views/fragments/footer.blade.php ENDPATH**/ ?>