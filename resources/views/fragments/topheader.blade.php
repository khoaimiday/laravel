<header class="tophead">
    <div class="tophead-menu">
        <ul class="tophead-menu-list">
            ...
            <li class="tophead-menu-left"><a href="{{ route('store') }}"><img src="{{url('img/nav/Store.png')}}" alt="">  Cửa hàng</a></li>
            ...
            <li class="tophead-menu-right"><a href="{{route('news')}}">Blog  <img src="{{url('img/nav/Blog2.png')}}" alt=""></a></li>    
        </ul>
    </div>
</header>
<style>
