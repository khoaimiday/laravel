<section class="about">
    ...
    <div class="row">
        <div class="col-md-3 featured-box">
            ...
            <img src="{{ url('img/logo_about/freeDelivery.png')}}" alt="">
            </div>
        ...
        <div class="col-md-3 featured-box about__border-left">
            <div class="about__img">
                <img src="{{ url('img/logo_about/heart.png')}}" alt="">
            </div>
            <div class="about__content">
        ...
        <div class="col-md-3 featured-box about__border-left">
            <div class="about__img">
                <img src="{{ url('img/logo_about/location.jpg')}}" alt="">
            </div>
            <div class="about__content">
        ...
        <div class="col-md-3 featured-box about__border-left">
            <div class="about__img">
                <img src="{{ url('img/logo_about/shoppingCart.png')}}" alt="">
            </div>
            <div class="about__content">
